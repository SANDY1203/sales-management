        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<div class="form-group">
					...
					<select class="selectpicker" id="user_id2">
  <?php 
...
echo $data;
  ...
  ?>
				...
				<select class="selectpicker" id="contact_id">
  <?php 
  include("ajax/db_connection.php");
  $data = '';
$query12 = "SELECT * FROM contact";
    ...
    if(mysql_num_rows($result12) > 0)
    {
			...
			$data .=	'<option value="'.$row12['id'].'">'. $row12['contact_name'].'</option>';
				}
	}
	else{
		$data .=	'<option></option>';
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<div class="form-group">
                    <label for="user_id">User Name</label>
<select class="selectpicker" id="update_user_id1">
  <?php 
  include("ajax/db_connection.php");
  $data = '';
$query12 = "SELECT * FROM users";
...
echo $data;
  ...
  ?>
				...
				<div class="form-group">
                    <label for="contact_id">Contact ID</label>
                <select class="selectpicker" id="update_contact_id">
  <?php 
  include("ajax/db_connection.php");
  $data = '';
$query12 = "SELECT * FROM contact";
                    ...
                    <div id="mainb">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-5 project_detail">
                                <p class="ng-binding"><span class="title control-label">User Name:</span><output id ="view_user_id1" style="display:inline"> </output></p>
