        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<div class="form-group">
                    <label for="proserv_id">Product Name</label>
                <select class="selectpicker" id="proserv_id1">
  <?php 
  include("ajax/db_connection.php");
  $data = '';
$query12 = "SELECT * FROM proserv";
    ...
    if(mysql_num_rows($result12) > 0)
    {
			...
			$data .=	'<option value="'.$row12['id'].'">'. $row12['product_name'].'</option>';
				}
	}
	else{
		$data .=	'<option></option>';
...
echo $data;
  ...
  ?>
				...
				<div class="form-group">
                    <label for="project_contractor_id">Project Contractor Name</label>
                <select class="selectpicker" id="project_contractor_id1">
  <?php 
  include("ajax/db_connection.php");
  $data = '';
$query12 = "SELECT * FROM company";
    ...
    if(mysql_num_rows($result12) > 0)
    {
			...
			$data .=	'<option value="'.$row12['company_id'].'">'. $row12['company_name'].'</option>';
				}
	}
	else{
		$data .=	'<option></option>';
...
echo $data;
  ...
  ?>
               ...
               <select class="selectpicker" id="project_team1">
  <?php 
  include("ajax/db_connection.php");
  $data = '';
$query12 = "SELECT * FROM team";
    ...
    if(mysql_num_rows($result12) > 0)
    {
			...
			$data .=	'<option value="'.$row12['team_id'].'">'. $row12['team_name'].'</option>';
				}
	}
	else{
		$data .=	'<option></option>';
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<div class="form-group">
                    <label for="proserv_id">Product Name</label>
                <select class="selectpicker" id="update_proserv_id1">
  <?php 
  include("ajax/db_connection.php");
  $data = '';
$query12 = "SELECT * FROM proserv";
...
echo $data;
  ...
  ?>
				...
				<div class="form-group">
                    <label for="project_contractor_id">Project Contractor Name</label>
                <select class="selectpicker" id="update_project_contractor_id">
  <?php 
  include("ajax/db_connection.php");
  $data = '';
$query12 = "SELECT * FROM company";
...
echo $data;
  ...
  ?>
				...
				<div class="form-group">
                    <label for="project_team">Project Team</label>
                <select class="selectpicker" id="update_project_team1">
  <?php 
  include("ajax/db_connection.php");
  $data = '';
$query12 = "SELECT * FROM team";
                    ...
                    <div id="mainb">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-5 project_detail">
                                <p class="ng-binding"><span class="title control-label">Product Name:</span><output id ="view_proserv_id1" style="display:inline"> </output></p>
                                <p class="ng-binding"><span class="title control-label">Project Contractor Name:</span><output id ="view_project_contractor_id" style="display:inline"> </output></p>
