...
$query12 = "SELECT * FROM questions";
    ...
    if(mysql_num_rows($result12) > 0)
    {
			...
			<input type="text" id="feedback'.$num.'" placeholder="Project Name" class="form-control"/>
			</div>';
			$num++;
				}
	}
...
<div class="form-group">
                    <label for="project_team">SUMMURY/REMARKS</label>
                    <input type="text" id="remarks" placeholder="Project Team" class="form-control"/>
                </div>
