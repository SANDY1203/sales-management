...
<?php 
	...
	$id12 = $_SESSION['user_id1'];
	
	
	$query = "SELECT * FROM company WHERE user_id = '$id12'";
	...
	$data = '<form method="post" name="template" action="indeex.php">';
	...
	$query = "SELECT * FROM projects WHERE project_company_id = '$company'";
    ...
    $data .= '</table>';
	$data .= '<button class="btn btn-success" data-toggle="modal">QUOTATION</button>';
	$data .= '</form>';
