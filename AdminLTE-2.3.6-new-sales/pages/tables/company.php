        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<div class="form-group">
					...
					<select class="selectpicker" id="user_id">
  <?php 
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<div class="form-group">
                    <label for="user_id">User Name</label>
                    <select class="selectpicker" id="update_user_id">
  <?php 
  include("ajax/db_connection.php");
  $data = '';
$query12 = "SELECT * FROM users";
                    ...
                    <div id="mainb">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-5 project_detail">
                                ...
                                <p class="ng-binding"><span class="title control-label">User Name:</span></span><output id ="view_user_id" style="display:inline"></p>
                            </div>
                        </div>
                    </div>
                    <!-- end main details -->
