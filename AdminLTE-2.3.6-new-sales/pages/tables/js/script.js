...
function ViewCompany(company_id) {
    ...
    $.post("ajax/readCompanyDetails.php", {
        ...
        function (data, status) {
            ...
            $("#view_user_id").val(user.first_name);
...
function ViewContact(id) {
    ...
    $.post("ajax/readContactDetails.php", {
        ...
        function (data, status) {
            ...
            $("#view_contact_company_allo").val(user.company_name);
        }
    );
    // Open modal popup
...
function ViewFeedback(id) {
    ...
    $.post("ajax/readFeedbackDetails.php", {
        ...
        function (data, status) {
            ...
            $("#view_user_id1").val(user.first_name);
            ...
            $("#view_contact_id").val(user.contact_name);
        }
    );
    // Open modal popup
...
function ViewProserv_Project(id) {
    ...
    $.post("ajax/readProserv_ProjectDetails.php", {
        ...
        function (data, status) {
            ...
            $("#view_proserv_id1").val(user.product_name);
            $("#view_project_contractor_id").val(user.company_name);
            $("#view_project_price1").val(user.project_price);
            $("#view_project_team1").val(user.team_name);
...
function ViewTeam_Members(team_m_id) {
    ...
    $.post("ajax/readTeam_MembersDetails.php", {
        ...
        function (data, status) {
            ...
            $("#view_team_id").val(user.team_name);
